...
It is important to assess how predictive this model is. We find that our penalized regression model does well in predicting survival of the patients in our set with a median concordance index of 0.78.
...
```{r}
new.data <- as.data.frame(matrix(rbinom(15*100,1,0.5),nrow=100,ncol = 15))
